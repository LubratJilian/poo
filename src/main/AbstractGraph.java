 ...
 * implementation between directed graph (main.DiGraph) and undirected
 * graph (main.UnDiGraph)
 */
public abstract class AbstractGraph implements Graph {
	 ...
	 * method raises a main.DuplicateTagException exception
	 */
	...
	/////////////// protected methods ///////////////
    // This method is protected because it is used by the subclasses
	...
	private class EdgeIterator implements Iterable<Edge>, Iterator<Edge> {
		...
		public Iterator<Edge> iterator() {
			return new EdgeIterator();
			//return this; you should not return this
		}
		...
		public boolean hasNext() {
			return
					secondMapIterator != null && (secondMapIterator.hasNext() || firstMapIterator.hasNext());
		}
	...
	private class IncidentEdgeIterator implements Iterable<Edge>, Iterator<Edge> {
		...
		public Iterator<Edge> iterator() {
			return new IncidentEdgeIterator(origin);
			//return this; // you should not return this
		}
